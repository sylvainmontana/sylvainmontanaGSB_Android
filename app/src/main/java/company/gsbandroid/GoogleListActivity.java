...
public final class GoogleListActivity extends ListActivity {

    private static final String GITHUB_JSON_URL = "https://www.indelogi.com/app_Xebia/contact.json";
    ...
    protected void onResume() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(GITHUB_JSON_URL,
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(GoogleListActivity.this, "Error while getting JSON: " + volleyError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }
        );
        request.setTag(this);
